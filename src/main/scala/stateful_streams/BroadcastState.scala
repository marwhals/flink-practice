...
object BroadcastState {
  ...
  //Scenario: Want to issue a warning if quantity if greater than a threshold
  ...
  // Consider: What happens if the threshold changes over time? Consider systems that run 24/7
  // thresholds will be / need to be broadcast
